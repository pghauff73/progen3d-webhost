...
const log2 = (...a) => {
    ...
    const msg = `${a.join(" ")}`;
    const out = (typeof document !== "undefined") && document.getElementById && document.getElementById("editorConsoleOutput");
...
(function () {
  ...
  function __pg3d_getOut() {
    try {
      ...
      return document.getElementById('editorConsoleOutput');
    } catch (e) { return null; }
  }
